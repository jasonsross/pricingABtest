# Pricing A/B Test
Evaluated whether a pricing test running on the site has been successful. 

## Description
66% of the users have seen the old price (​\$39), while a random sample of 33% users a higher price ($59). I answer the following

1. Should the company sell its software for \$39 or \$59?

3. After how many days could the test have been stopped conclusively?
